...
export default function NotFound() {
  return (
    <html className="flex flex-col justify-center items-center min-h-screen bg-[radial-gradient(ellipse_at_bottom,_var(--tw-gradient-stops))] from-[#0d0d0d] via-gray-900 to-black">
      <body>
        <div className="min-h-[calc(100vh_-_14vh)] md:min-h-[calc(100vh_-_22.5vh)] [animation-duration:2.5s] [animation-fill-mode:both] [animation-name:fadeIn] md:min-w-[850px] flex justify-center items-center">
